...
return (
    ...
    <div className="Emails relative bg-white text-black rounded-lg flex flex-col text-left px-5 py-5 h-auto max-h-[300px] overflow-y-auto ">
        <span className={` absolute top-0 right-0 ${!copy ? "bg-slate-300" :'bg-green-200' }   rounded m-2 p-1 hover:bg-gray-400 cursor-pointer flex`} onClick={Copy_Emails}> <b>{copy ? 'Cpyed':'Copy'}</b> &ensp;<img src="Copy.png" alt="copy"  /></span>
